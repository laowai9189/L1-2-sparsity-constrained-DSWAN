function [TrainingAccuracy,TestingAccuracy,Training_time,Testing_time] = DSWAN(train_x,train_y,test_x,test_y,b1,b2,b3,s,C,lam)
tic
...
clear b1;
beta1  =  l12_elm_autoencoder(A1,H1,lam,50)';
...
clear b2;
beta2 = l12_elm_autoencoder(A2,H2,lam,50)';
clear A2;
